...
> [!IMPORTANT]
> This repository currently depends on **IsaacLab v2.0.0** or higher. **isaacsim v4.5.0**.
...
```bash
# Train
python scripts/rsl_rl/base/train.py --task RobotLab-Isaac-Velocity-Rough-Piper-Go2-v0 --num_envs 4096 
# Play
python scripts/rsl_rl/base/play.py --task RobotLab-Isaac-Velocity-Rough-Piper-Go2-v0
```
...
```bash
# Train
python scripts/rsl_rl/base/train.py --task Isaac-Open-Drawer-Piper-v0 --num_envs 4096 
# Play
python scripts/rsl_rl/base/play.py --task Isaac-Open-Drawer-Piper-v0
```
...
```bash
# Train
python scripts/rsl_rl/base/train.py --task Isaac-Reach-Piper-v0 --num_envs 4096 
# Play
python scripts/rsl_rl/base/play.py --task Isaac-Reach-Piper-v0
```
...
python scripts/tools/convert_urdf.py source/robot_lab/data/Robots/Agilex/PIPER/piper_description.urdf source/robot_lab/data/Robots/Agilex/PIPER/piper.usd  --fix-base
```
