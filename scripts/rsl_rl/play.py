...
def main():
    ...
    # arm_joint_state_ctrl_publisher = rospy.Publisher("/joint_states", JointState, queue_size=10)
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            # init = [0, 1.57, -1.57, 0, 1.2, 0, 0.04, -0.04]
            # for i in range(6):
            #     joint_state_msg.position.append(actions[0, i] * 1.0 + init[i])  #
