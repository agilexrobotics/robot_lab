...
from robot_lab.tasks.manipulation.cabinet.cabinet_env_cfg import (  # isort: skip
...
# Pre-defined configs
##
from robot_lab.assets.agilex import AGILEX_PIPER_CFG

@configclass
class PiperCabinetEnvCfg(CabinetEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.grasp_handle.params["asset_cfg"].joint_names = ["joint8", "joint7"]


@configclass
class PiperCabinetEnvCfg_PLAY(PiperCabinetEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
