...
# Pre-defined configs
##
from robot_lab.assets.agilex import AGILEX_PIPER_HIGH_PD_CFG  # isort: skip
...
@configclass
class PiperCubeLiftEnvCfg(joint_pos_env_cfg.PiperCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot = AGILEX_PIPER_HIGH_PD_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class PiperTeddyBearLiftEnvCfg(PiperCubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        self.scene.robot.actuators["gripper_base"].effort_limit = 50.0
        self.scene.robot.actuators["gripper_base"].stiffness = 40.0
        self.scene.robot.actuators["gripper_base"].damping = 10.0
