...
@configclass
class PiperReachEnvCfg(joint_pos_env_cfg.PiperReachEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot.actuators["piper_shoulder"].stiffness = 0.0
        self.scene.robot.actuators["piper_shoulder"].damping = 0.0
        self.scene.robot.actuators["piper_forearm"].stiffness = 0.0
        self.scene.robot.actuators["piper_forearm"].damping = 0.0
